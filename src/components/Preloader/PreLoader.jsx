    ...
    <>
      <div className="relative" ref={comp}>
        ...
        >
          <h1
            id="welcome"
            className="text-xl sm:text-2xl md:text-4xl lg:text-6xl font-bold text-gray-100 font-spaceGrostesk flex items-center justify-center text-center px-3 sm:px-5"
          >
